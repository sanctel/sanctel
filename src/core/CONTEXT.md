...
PTY. Named by Tab or Worktree. Outlives the app. The reason tabs survive
app restart without explicit save logic.
...
- A **TmuxSession** is owned by the tmux server, named by Tab or Worktree;
  a terminal Tab points at one TmuxSession.
